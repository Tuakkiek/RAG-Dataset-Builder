...
¹ Khoa Công nghệ Thông tin và Truyền thông, Trường Đại học Hồng Đức, Email: phamtheanh@hdu.edu.vn  
...
$$
L=\mathrm{KL}(P\parallel Q)=\sum_i\sum_j p_{ij}\log\frac{p_{ij}}{q_{ij}}
$$
...
$$
\mathrm{ACC}=\max_m\frac{\sum_{i=1}^{n}\mathbf{1}\{l_i=m(c_i)\}}{n}
$$
...
[4] Bo Yang, Xiao Fu, Nicholas D. Sidiropoulos, Mingyi Hong (2016), Towards Kmeans-friendly Spaces: Simultaneous Deep Learning and Clustering, arXiv:1610.04794v2 [cs.LG].
...
[10] Simonyan, K., Zisserman, A. (2015), Very deep convolutional networks for largescale image recognition, 3rd International Conference on Learning Representations (ICLR 2015), 1-14.
