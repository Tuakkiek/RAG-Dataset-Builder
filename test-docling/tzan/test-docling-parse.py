...
duong_dan_doc = r"D:\GITHUB\RAG-Dataset-Builder\test-docling\tzan\Giáo trình khai phá dữ liệu.pdf"
...
duong_dan_luu = r"D:\GITHUB\RAG-Dataset-Builder\test-docling\tzan\ket_qua_Giáo trình khai phá dữ liệu.md"
