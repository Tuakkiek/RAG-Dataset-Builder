...
# CẢI TIẾN MÔ HÌNH DỊCH MÁY MẠNG NƠ-RÔN ANH-VIỆT SỬ DỤNG ĐỒ THỊ TRI THỨC

Lê Công Trí¹, Nguyễn Phương Nam¹, Nguyễn Hồng Bửu Long², Trần Thanh Nhã¹*
...
Tạp chí Khoa học Trường ĐHSP TPHCM Lê Công Trí và tgk
...
Tạp chí Khoa học Trường ĐHSP TPHCM Tập 22, Số 2 (2025): 235-246
...
Đầu tiên, tại lớp Masked Multi-Head Self-Attention các vector biểu diễn từ đầu vào $(\vec{y}_1,\vec{y}_2,\ldots,\vec{y}_m)$ với m là số lượng từ đã được dịch;

Tiếp theo, tại lớp Multi-Head Cross-Attention các vector $\vec{z}$ sẽ được dùng làm Query (Q), trong khi các vector $(\vec{x}_1,\vec{x}_2,\ldots,\vec{x}_m)$ từ bộ mã hóa sẽ được sử dụng làm Key (K) và Value (V) cho Multihead-Attention;
...
| Tập ngữ liệu | Số câu | Tiếng Anh | Tiếng Việt |
| --- | ---: | ---: | ---: |
...
Papineni, K., Roukos, T., Ward, T., & Zhu, W.-J. (2002). BLEU: A method for automatic evaluation of machine translation. Annual Meeting of the Association for Computational Linguistics (pp.311-318). https://doi.org/10.3115/1073083.1073135
...
Vaswani, A., Shazeer, N., Parmar, V., Uszkoreit, J., Jones, L., Gomez, A. N., Kaiser, Ł., & Polosukhin, I. (2017). Attention is all you need. In Advances in Neural Information Processing Systems, 30. https://doi.org/10.48550/arXiv.1706.03762
...
Le Cong Tri¹, Nguyen Phuong Nam¹, Nguyen Hong Buu Long², Tran Thanh Nha¹*
