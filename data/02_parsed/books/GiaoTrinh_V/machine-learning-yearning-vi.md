...
Ví dụ, nhóm của bạn phát triển một hệ thống hoạt động tốt trên tập phát triển nhưng kém trên tập kiểm tra. Nếu tập phát triển và tập kiểm tra có cùng một phân phối, thì bạn có thể xác định ngay vấn đề: Mô hình của bạn đã quá khớp (overfit) tập phát triển. Cách xử lý hiển nhiên nhất đó là bổ sung thêm dữ liệu cho tập phát triển.
...
<!-- page: 18 -->
trị. Tính toán giá trị trung bình hoặc giá trị trung bình có trọng số là một trong những cách phổ biển nhất để kết hợp nhiều phép đo thành một.
**CHÚ THÍCH:**
...
<!-- page: 22 -->
ra mắt ứng dụng, bạn nhận ra rằng người dùng lại tải lên ảnh mèo con nhiều hơn dự tính. Khi đó, phân phối của tập phát triển/kiểm tra không đại diện cho phân phối thực tế mà cần bạn hướng tới. Trong trường hợp này, bạn cần cập nhật tập phát triển/kiểm tra sao cho chúng có tính đại diện hơn.
...
Việc phân tích lỗi thường giúp bạn nhìn thấy được triển vọng của những hướng giải

<!-- page: 27 -->
quyết khác nhau. Tôi thấy nhiều kỹ sư tiến hành phân tích lỗi môt cách miễn cưỡng. Dường như đối với họ ngay lập tức thực hiện một số ý tưởng sẽ thú vị hơn là tự hỏi xem ý tưởng đó có thật sự đáng để bạn bỏ thời gian thực hiện. Đây là một lỗi phổ biến: nó có thể gây lãng phí hàng tháng chỉ để nhận ra rằng sự cải thiện là không đáng kể.
...
- Lỗi huấn luyện = 15%
- Lỗi phát triển = 16%
Chúng ta ước tính độ chệch là 15% và phương sai là 1%. Bộ phân loại này khớp kém với tập huấn luyện với 15% lỗi nhưng lỗi ở tập phát triển chỉ cao hơn một chút so với tập huấn luyện. Do đó, bộ phân loại này có độ chệch cao nhưng phương sai thấp. Chúng ta nói thuật toán này đang dưới khớp (underfit).
Bây giờ hãy xem xét trường hợp sau:
- Lỗi huấn luyện = 15%
- Lỗi phát triển = 30%
...
"Độ chệch tránh được" phản ánh thuật toán của bạn hoạt động kém hơn bao nhiêu

<!-- page: 42 -->
so với "bộ phân loại tối ưu".
...
[9] Những định nghĩa này được chọn để truyền đạt cái nhìn sâu sắc về cách cải thiện thuật toán học máy của bạn. Những định nghĩa này khác với cách các nhà thống kê

<!-- page: 43 -->
định nghĩa Độ chệch và Phương sai. Về mặt kỹ thuật, những gì tôi định nghĩa là "Độ chệch" nên được gọi là "Lỗi chúng ta quy cho độ chệch" và "Độ chệch tránh được" nên là "Lỗi chúng ta quy cho độ chệch của thuật toán học mà lớn hơn tỉ lệ lỗi tối ưu" .
...
Tăng kích thước mô hình (ví dụ như số lượng nơ-ron/tầng): Kĩ thuật này giúp giảm độ chệch vì nó cho phép khớp (fit) tập huấn luyện tốt hơn. Nếu thấy việc này làm tăng phương sai, bạn hãy dùng điều chuẩn (regularization) -- thường dùng để giảm trừ việc tăng phương sai.
...
Cuối cùng, vẽ đồ thị quá trình học có thể tốn kém về mặt tính toán: Ví dụ: bạn có thể phải huấn luyện mười mô hình với 1.000, rồi 2.000, cho đến 10.000 mẫu. Huấn luyện các mô hình với các bộ dữ liệu nhỏ nhanh hơn nhiều so với huấn luyện các mô hình với các bộ dữ liệu lớn. Do đó, thay vì cách đều các kích thước tập huấn luyện

<!-- page: 58 -->
theo tỷ lệ tuyến tính như trên, bạn có thể huấn luyện các mô hình với 1.000, 2.000, 4.000, 6.000 và 10.000 mẫu. Điều này vẫn sẽ cung cấp cho bạn một cảm giác rõ ràng về các xu hướng trong các đồ thị quá trình học. Tất nhiên, kỹ thuật này chỉ thích hợp nếu chi phí tính toán để huấn luyện tất cả các mô hình bổ sung là đáng kể.
**CHÚ THÍCH**
...
- Khó tin tưởng trực giác của con người. Ví dụ, gần như không ai có thể dự đoán được thị trường chứng khoán. Vì thế, nếu thuật toán dự đoán cổ phiếu của chúng

<!-- page: 61 -->
- ta không tốt hơn dự đoán ngẫu nhiên, thì thật khó để tìm ra cách cải thiện nó.
...
Chọn tập phát triển và kiểm tra phản ánh dữ liệu bạn mong muốn hệ thống hoạt động tốt trong tương lai.
...
Hãy xem xét một ví dụ thứ hai. Giả sử bạn đang xây dựng một hệ thống nhận diện giọng nói để phiên thoại địa chỉ đường cho một ứng dụng bản đồ/định vị trên di động

<!-- page: 66 -->
điều khiển bằng giọng nói. Bạn có 20.000 mẫu của người dùng nói về địa chỉ đường. Nhưng bạn cũng có 500.000 mẫu là những bản ghi âm khác của người dùng đang nói về những chủ đề khác. Bạn có thể lấy 10.000 mẫu nói về địa chỉ đường cho tập phát triển/kiểm tra, và sử dụng 10.000 mẫu còn lại, cộng thêm 500.000 mẫu, cho việc huấn luyện.
...
Để mô tả ảnh hưởng thứ hai theo các thuật ngữ khác nhau, chúng ta có thể mượn nhân vật hư cấu Sherlock Holmes, người nói rằng bộ não của bạn giống như một căn gác; nó chỉ có một không gian hữu hạn. Anh ta nói rằng "mỗi lần bổ sung kiến thức,

<!-- page: 68 -->
bạn sẽ quên đi những điều mà bạn biết trước đây. Do đó, điều quan trọng bậc nhất là không để những thông tin vô dụng lấn át những thông tin hữu ích." [12]
...
![Hinh: fig-71-2]
Nếu bạn chọn trọng số β = 1/40, thuật toán sẽ đối xử với 5.000 hình ảnh từ di động tương đương với 200.000 hình ảnh từ internet. Bạn cũng có thể chọn các giá trị khác cho β, chẳng hạn như tinh chỉnh theo tập phát triển.
...
- Tập phát triển huấn luyện: Đây là dữ liệu trích xuất từ cùng phân phối với tập huấn luyện (ví dụ: ảnh Internet + ảnh Điện Thoại). Tập dữ liệu này thường nhỏ hơn tập huấn luyện và chỉ cần đủ lớn để có thể đánh giá và theo dõi quá trình học
...
<!-- page: 79 -->
### 44. Bài kiểm tra xác minh tối ưu
Giả sử bạn đang xây dựng một hệ thống nhận dạng giọng nói. Hệ thống hoạt động bằng cách nhập một đoạn âm thanh A, và tính toán một giá trị Điểm (S) cho mỗi câu đầu ra khả dĩ S. Ví dụ: bạn có thể thử ước tính Điểm (S) = P(S|A), tức xác suất bản ghi thoại đầu ra chính xác là câu S với điều kiện âm thanh đầu vào là A.
A
A
Khi có cách tính Điểm (S), bạn vẫn phải tìm câu tiếng Anh S để tối đa hóa nó:
A
![Hinh: fig-80-1]
Làm thế nào để tính toán được "arg max" ở trên? Nếu tiếng Anh có 50.000 từ thì sẽ có (50.000) câu khả dĩ có độ dài N -- quá nhiều để liệt kê một cách triệt để.
N
Vì vậy, bạn cần áp dụng thuật toán tìm kiếm gần đúng, để cố gắng tìm giá trị S nhằm tối ưu hóa (tối đa hóa) Điểm (S). Ví dụ, với thuật toán tìm kiếm chùm tia (beam search), thuật toán này chỉ giữ K ứng viên hàng đầu trong quá trình tìm kiếm. (Đối với mục đích của chương này, bạn không cần phải hiểu chi tiết về tìm kiếm chùm tia.) Các thuật toán như thế này không đảm bảo được việc tìm giá trị của S mà tối đa hóa Điểm (S).
A
A
...
1. Vấn đề về thuật toán tìm kiếm. Thuật toán tìm kiếm gần đúng (tìm kiếm chùm tia) không thể tìm thấy giá trị S thỏa mãn việc tối đa hóa Điểm (S).
A
2. Vấn đề về hàm mục tiêu (hàm tính điểm). Ước lượng của chúng ta về Điểm (S) = P(S|A) không chính xác. Cụ thể, việc chọn cách tính Điểm (S) thất bại trong việc xác định "Tôi yêu thích học máy" là bản ghi thoại chính xác.
A A
Tùy thuộc vào nguyên nhân nào dẫn đến thất bại mà bạn ưu tiên tập trung vào các hướng giải quyết khác nhau. Nếu #1 là vấn đề, bạn nên cải thiện thuật toán tìm kiếm. Nếu #2 là vấn đề, bạn nên làm việc với thuật toán học ước lượng Điểm (S).
A
Đối mặt với tình huống này, một số nhà nghiên cứu sẽ ngẫu nhiên quyết định làm việc trên thuật toán tìm kiếm; những người khác sẽ ngẫu nhiên làm việc theo cách tốt hơn để thuật toán học các giá trị cho Điểm (S). Nhưng nếu bạn không biết nguyên nhân nào trong số này là nguyên nhân cơ bản tạo nên lỗi, nỗ lực của bạn có thể trở nên lãng phí. Làm thế nào bạn có thể quyết định nên làm gì một cách có hệ thống hơn?
A
out *
Đặt S là bản ghi thoại đầu ra ("Tôi yêu thích người máy"). Đặt S là bản ghi thoại chính xác ("Tôi yêu thích học máy"). Để hiểu vấn đề #1 hay #2 ở trên là nguyên nhân, bạn có thể thực hiện Bài kiểm tra xác minh tối ưu: Đầu tiên, tính Điểm (S ) và Điểm (S ). Sau đó kiểm tra xem Điểm (S ) > Điểm (S ) có đúng hay không. Có hai khả năng:
A *
A out A * A out

<!-- page: 80 -->
A * A out
Trường hợp 1: Điểm (S ) > Điểm (S )
* out
Trong trường hợp này, thuật toán học của bạn đã tính S cao hơn S . Tuy nhiên, thuật toán tìm kiếm gần đúng đã chọn S thay vì S . Điều này cho bạn biết rằng thuật toán tìm kiếm gần đúng của bạn có lỗi trong việc chọn giá trị S tối đa hóa Điểm (S). Trong trường hợp này, Bài kiểm tra xác minh tối ưu cho bạn biết rằng bạn có vấn đề về thuật toán tìm kiếm và nên tập trung vào đó. Ví dụ, bạn có thể thử tăng độ rộng chùm tia của tìm kiếm chùm tia.
out *
- A
A * A out
Trường hợp 2: Điểm (S ) ≤ Điểm (S )
Trong trường hợp này, bạn biết việc bạn tính toán Điểm (.) có lỗi: Không thể cho điểm đầu ra chính xác S cao hơn hẳn so với S không chính xác. Bài kiểm tra xác minh tối ưu cho bạn biết rằng bạn có vấn đề về hàm mục tiêu (tính điểm). Vì vậy, bạn nên tập trung vào việc cải thiện thuật toán học hoặc cách xấp xỉ Điểm (S) cho các câu S khác nhau.
A * out
A
Thảo luận của chúng ta tới giờ mới chỉ tập trung vào một ví dụ duy nhất. Để áp dụng Bài kiểm tra xác minh tối ưu trong thực tế, bạn nên kiểm tra lỗi trong tập phát triển của mình. Với mỗi lỗi, bạn sẽ kiểm tra xem liệu Điểm (S ) > Điểm (S ) không. Mỗi ví dụ trong tập phát triển mà bất đẳng thức này thoả mãn được đánh dấu là lỗi gây ra bởi thuật toán tối ưu. Mỗi ví dụ không thỏa mãn (Điểm (S ) ≤ Điểm (S )) được đánh dấu là một lỗi do cách tính Điểm (.).
A * A out
A * A out
A
Ví dụ, giả sử bạn tìm ra rằng 95% các lỗi là do hàm tính điểm Điểm (.) và chỉ 5% có nguyên do từ phía thuật toán tối ưu. Giờ bạn biết rằng dù có cải thiện quá trình tối ưu thế nào thì bạn cũng chỉ có thể loại bỏ được khoảng 5% lỗi. Thay vào đó, bạn nên tập trung cải thiện cách ước lượng Điểm (.).
A
A

<!-- page: 81 -->
### 45. Dạng tổng quát của bài kiểm tra xác minh tối ưu
Bạn có thể áp dụng Bài kiểm tra xác minh tối ưu khi, với đầu vào x, bạn biết cách tính Điểm (y) dùng để thể hiện mức độ phản hồi y tốt như thế nào với x. Hơn nữa, bạn đang sử dụng thuật toán gần đúng để cố gắng tìm arg max Điểm (y), nhưng nghi ngờ rằng thuật toán tìm kiếm đôi khi không tìm thấy giá trị lớn nhất. Trong ví dụ nhận dạng giọng nói trước đây, x=A là một đoạn âm thanh và đầu ra y=S là bản ghi thoại.
*
y *
Giả sử y* là đầu ra "chính xác" nhưng thuật toán thay vào đó tìm ra y . Khi đó bài kiểm tra then chốt là đo xem liệu Điểm (y*) > Điểm (y ) có đúng hay không. Nếu bất đẳng thức này đúng thì chúng ta coi lỗi là do thuật toán tối ưu. Tham khảo chương trước để đảm bảo bạn hiểu logic đằng sau điều này. Ngược lại, chúng ta coi lỗi thuộc về cách tính Điểm (y).
out
* * out
*
Xem xét một ví dụ nữa. Giả sử bạn đang xây dựng một hệ thống dịch máy từ tiếng Trung sang tiếng Anh. Hệ thống của bạn nhận một câu tiếng Trung C và tính giá trị Điểm (E) cho mỗi bản dịch khả dĩ E. Ví dụ, bạn có thể sử dụng Điểm (E) = P(E|C), xác suất dịch ra E với câu đầu vào C.
- C C
...
Giả sử thuật toán cho ra một bản dịch không chính xác E thay vì một bản dịch chính xác E* nào đó. Khi đó bài kiểm tra xác minh tối ưu sẽ yêu cầu bạn tính toán xem liệu Điểm (E*) > Điểm (E ) đúng hay không. Nếu bất đẳng thức này đúng thì cách tính Điểm (.) đã nhận dạng chính xác E* tốt hơn so với E ; do đó, bạn sẽ coi lỗi này là do thuật toán tìm kiếm gần đúng. Ngược lại, bạn coi lỗi này thuộc về cách tính Điểm (.)
out
C C out
C out
C
...
Với một hàm điểm thưởng R(T) cho trước, công việc của thuật toán học tăng cường là điều khiển trực thăng sao cho nó đạt được điểm thưởng cao nhất max R(T). Tuy nhiên, thuật toán học tăng cường có nhiều phép xấp xỉ và có thể sẽ không thành
T

<!-- page: 83 -->
công trong việc tối ưu này.
Giả sử bạn đã có một hàm điểm thưởng R(.) nào đó và đã chạy thuật toán học của bạn. Tuy nhiên, chất lượng của nó còn thua xa chất lượng của người lái (ví dụ: hạ cánh xóc hơn và có vẻ kém an toàn hơn so với chất lượng của phi công). Làm sao để bạn biết được liệu đó có phải là lỗi của thuật toán học tăng cường -- được dùng để tính toán một quỹ đạo để tối đa max R(T) -- hay là lỗi của hàm điểm thưởng -- được dùng để đo cũng như xác định mức đánh đổi lý tưởng giữa độ xóc của chuyến bay và độ chính xác của vị trí hạ cánh?
T
Để áp dụng Bài kiểm tra xác minh tố ưu, cho T là quỹ đạo bay của phi công và cho T là quỹ đạo đạt được của thuật toán. Dựa theo mô tả phía trên, T là quỹ đạo tốt hơn so với T . Do vậy, bài kiểm tra then chốt là: Liệu có đúng không khi R(T ) > R(T )?
người
ra người
ra
- người ra
Trường hợp 1: Nếu bất đẳng thức này đúng, thì hàm điểm thưởng R(.) đang đánh giá đúng rằng T vượt trội hơn so với T . Nhưng vậy thì thuật toán học tăng cường đang tìm T kém hơn. Điều này gợi ý rằng bỏ công sức để cải thiện thuật toán học tăng cường là xứng đáng.
người ra
ra
Trường hợp 2: Bất đẳng thức trên không đúng: R(T ) ≤ R(T ). Tức là R(.) đang gán cho T một điểm số tệ hơn dù cho nó là quỹ đạo tốt hơn. Bạn nên cải thiện R(.) để có thể nắm bắt việc đánh đổi giữa các tiêu chí tương đương với một cú hạ cánh tốt.
người ra
người
Nhiều ứng dụng machine learning có chung "khuôn mẫu" là tối ưu xấp xỉ một hàm tính điểm Điểm (.) sử dụng một thuật toán tìm kiếm xấp xỉ. Đôi khi, cũng không tồn tại một đầu vào x được chỉ định trước vậy nên hàm chỉ còn là Điểm(.). Trong ví dụ trên, hàm tính điểm chính là hàm điểm thưởng Điểm(T) = R(T) và thuật toán tối ưu là thuật toán học tăng cường đang cố thực thi một quỹ đạo bay T tốt.
x
Một điểm khác biệt so với những ví dụ trước là, thay vì so sánh với một kết quả "tối ưu", bạn so sánh với chất lượng mức con người T . Chúng ta giả sử T khá là tốt, dù có thể không tối ưu. Nhìn chung, miễn là bạn có kết quả y* (trong ví dụ này, T ) tốt hơn so với thuật toán học hiện thời -- mặc dù có thể nó không phải là kết quả "tối ưu" -- thì Bài kiểm tra xác minh tối ưu có thể chỉ ra liệu cải thiện thuật toán tối ưu hay cải thiện hàm tính điểm sẽ hứa hẹn hơn.
người người
người
...
<!-- page: 90 -->
nhỏ, nó có thể có chất lượng tệ hơn pipeline với đặc trưng được thiết kế thủ công.
...
Tổng quát hơn, nếu có rất nhiều dữ liệu sẵn có để huấn luyện "các mô-đun trung

<!-- page: 92 -->
gian" của một pipeline (chẳng hạn như một bộ phát hiện xe hơi và một bộ phát hiện người đi bộ), thì bạn có thể xem xét sử dụng một pipeline với nhiều bước. Kiến trúc này có thể ưu việt bởi vì bạn có thể sử dụng tất cả dữ liệu sẵn có để huấn luyện các mô-đun trung gian.
...
Bạn có thể gọi tên ba thành phần trong hệ thống là A, B, C tương ứng với các chức năng như sau: A: Phát hiện xe hơi

<!-- page: 106 -->
B: Phát hiện người đi bộ C: Hoạch định đường đi cho xe
...
Dự án dịch sách này không thể thành công nếu không có sự đóng góp của cộng đồng. Xin gửi lời cảm ơn tới Forum Machine Learning Cơ Bản đã theo dõi và ủng hộ suốt quá trình dự án.
Hy vọng quyển sách này sẽ trở thành một sổ tay Học Máy hữu ích cho các độc giả. Và hy vọng đây sẽ là dự án đầu tiên đặt nền móng cho các dự án cộng đồng tương tự khác. Hiện tại, các thành viên trong nhóm đang triển khai dự án thứ hai -- dịch Dive into Deep Learning -- Đắm mình vào Học Sâu. Nếu bạn đang đọc những dòng này và nghĩ mình có thể đóng góp, mời bạn tham gia đóng góp thực hiện.
...
| 4. | #83 | ngcthuong | tiepvupsu, 1612628, SumoBBQ, quangnhat185, lkhphuc, duythanhvn |
| 5. | #82 | habom2310 | ngcthuong, tiepvupsu, SumoBBQ, 1612628, vudaoanhtuan |
| 6. | #91 #262 | quangnhat185, ngcthuong | tiepvupsu, ngcthuong, SumoBBQ, 1612628, freeloneman |
| 7. | #70 | lkhphuc | tiepvupsu, ngcthuong, SumoBBQ |
| 8. | #80 | khoapip | ngcthuong, tiepvupsu, 1612628 |
| 9. | #77 | naml3i | ngcthuong, tiepvupsu |
| 10. | #117 | patrickphatnguyen | ngcthuong, damminhtien, xuantubk, 1612628 |
...
| 15. | #161 | quangnhat185 | duythanhvn, william-vu, 1612628, SumoBBQ, thhung |
| 16. | #164 | rootonchair | william-vu, naml3i, tiepvupsu, 1612628, SumoBBQ |
| 17. | #168 | khoapip | william-vu, 1612628, ngcthuong, tiepvupsu |
...
| 23. | #175 | seanphan | tiepvupsu, duythanhvn, ngcthuong, thhung |
...
| 30. | #228 | khoapip | tiepvupsu, 1612628, william-vu, SumoBBQ, ngcthuong |
| 31. | #248 | thhung | tiepvupsu |
| 32. | #251 | william-vu | 1612628, sonvx, SumoBBQ, naml3i, ngcthuong |
| 33. | #247 | honghanhh | tiepvupsu, 1612628, naml3i, phamdinhkhanh |
| 34. | #254 | seanphan | tiepvupsu, thhung, naml3i, lkhphuc, ngcthuong |
| 35. | #276 | duythanhvn | lkhphuc, ngcthuong, hungvminh |
| 36. | #273 | rootonchair | lkhphuc, tiepvupsu, william-vu |
| 37. | #279 | seanphan | quangnhat185, sonvx, 1612628, ngcthuong |
...
| Chương | Thảo luận | Dịch | Phản biện |
| --- | --- | --- | --- |
| 40. | #282 | quangnhat185 | seanphan, rootonchair, ngcthuong, honghanhh, tiepvupsu |
| 41. | #278 | lkhphuc | sonvx, ngcthuong, tiepvupsu |
| 42. | #298 | naml3i | tiepvupsu |
| 43. | #296 | seanphan | tiepvupsu, ngcthuong, rootonchair |
| 44. | #301, #312 | honghanhh, tiepvupsu | tiepvupsu |
| 45. | #304 | tiena2cva | rootonchair, tiepvupsu, ngcthuong, 1612628, lkhphuc |
| 46. | #329 | lkhphuc | sonvx, ngcthuong, tiepvupsu |
| 47. | #333, #336 | rootonchair, quangnhat185 | tiepvupsu |
| 48. | #360 | nerophung | lkhphuc, tiepvupsu |
| 49. | #340 | tiepvupsu | lkhphuc, rootonchair |
| 50. | #342 | tiepvupsu | william-vu, lkhphuc, rootonchair, 1612628 |
| 51. | #349 | tiepvupsu | william-vu, lkhphuc, ngcthuong, nmdang |
| 52. | #363 | khoapip | tiepvupsu, lkhphuc, thhung |
| 53. | #355 | lkhphuc | tiepvupsu, rootonchair |
| 54. | #352 | quangnhat185 | tiepvupsu |
| 55. | #364 | goldenretriever2015 | tiepvupsu, lkhphuc, nmdang, ngcthuong |
...
| 47 - 49 | khoapip | tiepvupsu, lkhphuc, ngcthuong, rootonchair |
